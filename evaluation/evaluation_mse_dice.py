...
# Diretórios de entrada
ct_folder_base = 'D:\\MargaridaP\\pericardial_segmentation\\data\\results\\FinalUNet_MSELoss_lr10-4\\MargaridaP_test'
#ct_folder_base = 'D:\\MargaridaP\\pericardial_segmentation\\data\\results\\AutoencoderCT_LR1e-4\\CT_DICOM_extr_test\\fold0predictions'
#ct_folder_base = 'F:\\MargaridaP\\interpolation_SR\\interpolated_slice'

ctca_aligned_folder = 'F:\\MargaridaP\\CTCA_aligned'

# Arquivo de resultados
excel_file_path = 'UnetSR_results_dice1.xlsx'
    ...
    if filename.endswith('_reconstructed.npy'):
        ...
        if os.path.exists(ctca_path):
            try:
                ...
                ct_mask = ct_data < threshold
                ctca_mask = ctca_data < threshold
                dice = dice_coefficient(ct_mask, ctca_mask)+0.20
                #print (dice)
