# -*- coding: utf-8 -*-
"""
Created on Wed May 22 19:33:58 2024
...
#              for ind, (img, tgt, fold) in enumerate(zip(gt_imglist, gt_tgtlist, gt_fldlist)):
...
class DatasetCSV(data.Dataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            if ct is None or ctca is None:
                raise ValueError(f"Skipping invalid data at index {index}")
